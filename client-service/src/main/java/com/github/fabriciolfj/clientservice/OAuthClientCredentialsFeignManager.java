...
public class OAuthClientCredentialsFeignManager {
    ...
    public OAuthClientCredentialsFeignManager(OAuth2AuthorizedClientManager authorizedClientManager, ClientRegistration clientRegistration) {
    ...
    public String getAccessToken(final ClientRegistration clientRegistration) {
        try {
            OAuth2AuthorizeRequest oAuth2AuthorizeRequest = OAuth2AuthorizeRequest
                    .withClientRegistrationId(clientRegistration.getRegistrationId())
                    .principal("payment-app")
                    .build();
